...
[trooth.co](https://www.trooth.co) · [Trust Center](https://www.trooth.co/security) · [EU AI Act API](https://www.trooth.co/products/eu-ai-act-api) · [Pricing](https://www.trooth.co/pricing)
...
| [`trust-verifier-sdk`](https://github.com/troothllc/trust-verifier-sdk) | Independently verify any Trust Receipt without trusting Trooth. Ed25519 and RFC 3161 verification against our published keys. |
...
- **Customers:** Run a free scan at [trooth.co](https://www.trooth.co).
- **Developers:** Read the [Trooth Trust Protocol specification](https://www.trooth.co/docs/trust-protocol) and the [API reference](https://www.trooth.co/docs/api).
- **Security researchers:** See our [Vulnerability Disclosure Policy](https://www.trooth.co/vdp) and [/.well-known/security.txt](https://www.trooth.co/.well-known/security.txt).
- **Procurement:** Browse verified vendors in the [Trooth Network](https://www.trooth.co/network).

## Trust Center

Our compliance posture is documented at [trooth.co/security](https://www.trooth.co/security). Government-verified credentials, self-attested conformance statements, subprocessor list, and customer documents available on request under NDA.
